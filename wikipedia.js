...
/*function to change button behaviour*/
function salmanda1(){
...
document.getElementById
 ("demo2"). style. fontsize ="30%";

document.getElementById
 ("demo2"). style. background ="maroon";
}
...
/*function to change button behavior menu*/
...
function salmandaiix(){
document.getElementById ("demoiix"). style. color ="white";

document.getElementById ("demoiix"). style. fontweight ="bold";

document.getElementById
 ("demoiix"). style. fontsize ="30%";

document.getElementById
 ("demoiix"). style. background ="maroon";
}
